...
const AdminDashboard = () => {
  ...
  const fetchPendingTailors = async () => {
    try {
      const res = await axios.get(`${baseURL}/admin/tailor-requests`);
      setPendingTailors(res.data.tailors || []);
    } catch (error) {
  ...
  const handleAccept = async (id) => {
    try {
      await axios.post(`${baseURL}/admin/tailor-requests/${id}/accept`);
      fetchPendingTailors();
    } catch (error) {
  ...
  const handleDecline = async (id) => {
    try {
      await axios.post(`${baseURL}/admin/tailor-requests/${id}/decline`);
      fetchPendingTailors();
    } catch (error) {
    ...
    <div className="space-y-8 p-6">
      ...
      <section className="bg-white p-6 rounded-lg shadow">
        ...
        <div className="flex space-x-6">
          <div className="p-6 bg-gray-100 rounded-lg shadow-md w-1/3 text-center border-2 border-gray-300">
